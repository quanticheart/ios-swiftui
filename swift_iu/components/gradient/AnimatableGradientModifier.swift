...
extension View {
    ...
    func addAnimatedGradient(progress: CGFloat, callback: @escaping (CGFloat)-> Void) -> some View {
        self.animatableGradient(fromGradient: gradient1, toGradient: gradient2, progress: progress)
        .ignoresSafeArea()
        .onAppear {
